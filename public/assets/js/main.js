...
(function ($) {
  ...
  var AUTO_SPEED = 500;   // autoplay transition speed
  var CLICK_SPEED = 100;   // button click transition speed
  ...
  var swiper = new Swiper(".mySwiper-banner-one", {
    ...
    speed: AUTO_SPEED, // autoplay speed
    ...
    on: {
      slideChangeTransitionEnd: function () {
        // restore autoplay speed after manual click
        swiper.params.speed = AUTO_SPEED;
      }
    }
  });
  ...
  $(".swiper-button-next").on("click", function (e) {
    e.preventDefault();
    swiper.params.speed = CLICK_SPEED;
    swiper.slideNext();
  });
