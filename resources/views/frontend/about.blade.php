        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about-area-inner-wrapper-thumbnail">
                    ...
                    <figure class="left-image">
                        <img src="assets/images/about/01.webp" alt="VegaVision enterprise software platforms dashboard"
                            loading="lazy" />
                    </figure>

                    <figure class="left-image last">
                        <img src="assets/images/about/about-2.jpg"
                            alt="VegaVision digital platform solutions for enterprises" loading="lazy" />
                    </figure>

                    <!-- Experience Badge -->
                    <div class="experience" aria-hidden="true">
                        <img src="assets/images/banner/04.png" alt="" loading="lazy" />
                    </div>
            ...
            <div class="col-lg-6 pl--50 pl_md--10 pl_sm--10 pt_md--50 pt_sm--50">
                <div class="about-content-style-one">
                    ...
                    <p class="disc">
                        Our platforms support large , public sectors , financial services, educational institutions,
                    ...
                    <a href="solutions.php" class="rts-btn btn-primary"
                        aria-label="Learn more about VegaVision and MBV Group">
                        Learn More
                    </a>
